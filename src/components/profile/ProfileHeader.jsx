...
export default function ProfileHeader() {
  ...
  const categoryColor =
    categoryColorMap[user?.diabetes_type] ?? "bg-gray-100 text-gray-700";
  const profileBorderColor =
    profileBorderColorMap[user?.diabetes_type] ?? "border-2 border-gray-300";
      ...
      <div className="flex flex-col gap-2 w-full md:w-auto">
        <Button
          ...
          className="px-6 py-3 cursor-pointer rounded-xl text-white
            ...
            bg-[length:200%_auto] 
            bg-left transition-all duration-500 ease-out
